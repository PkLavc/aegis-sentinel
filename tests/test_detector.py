...
class TestIsolationForestDetector:
    ...
    def detector(self, detector_config):
        ...
        return IsolationForestDetector(detector_config)
    ...
    async def test_detect_anomaly_without_training(self, mock_isolation_forest, detector, sample_metrics):
    ...
    @patch('src.detector.IsolationForest')
    async def test_detect_anomaly_with_training(self, mock_isolation_forest, detector, sample_metrics):
    ...
    @patch('src.detector.IsolationForest')
    async def test_detect_anomaly_with_anomaly(self, mock_isolation_forest, detector, sample_metrics):
    ...
    @patch('src.detector.IsolationForest')
    async def test_train_model(self, mock_isolation_forest, detector, sample_metrics):
...
class TestStatisticalDetector:
    ...
    def detector(self, detector_config):
        ...
        return StatisticalDetector(detector_config)
    ...
    async def test_detect_anomaly_without_training(self, detector, sample_metrics):
        """Test anomaly detection without sufficient training data."""
        result = await detector.detect_anomaly(sample_metrics[:5])  # Insufficient data
    ...
    async def test_detect_anomaly_with_training(self, detector, sample_metrics):
    ...
    async def test_detect_anomaly_with_statistical_anomaly(self, detector, sample_metrics):
    ...
    async def test_calculate_statistics(self, detector, sample_metrics):
...
class TestAnomalyDetectorService:
    ...
    async def test_detect_anomalies(self, detector_service, sample_metrics):
    ...
    async def test_detect_api_anomalies(self, detector_service):
    ...
    def test_is_ready(self, detector_service):
